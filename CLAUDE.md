...
- **Languages:** python (primary), bash, contract, editorconfig, gitignore, go, html, json, markdown, perl, py, toml, yaml
- **Most-referenced symbols:** `kupala.responses.response` (41 usages), `append` (41 usages), `get` (30 usages), `scope_f` (30 usages), `ServerSentEvent` (26 usages), `pytest` (25 usages), `events` (24 usages), `Routes` (23 usages), `kupala.responses.ServerSentEvent` (23 usages), `BaseHTTPError` (22 usages)
- **Graph size:** 1347 nodes, 3944 edges
- **Breakdown:** 16 builtins, 19 contracts, 40 docs, 66 files, 171 functions, 131 imports, 162 methods, 111 modules, 386 params, 4 todos, 101 types, 140 variables
