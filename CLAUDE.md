...
- **Languages:** python (primary), bash, contract, editorconfig, gitignore, go, html, jinja, json, markdown, perl, py, toml, yaml
- **Entry points:** ``, ``, `packages/kupala/src/kupala/cli.py`, `packages/kupala/src/kupala/commands.py`
- **Most-referenced symbols:** `kupala.openapi` (154 usages), `Routes` (130 usages), `kupala.routing.Routes` (129 usages), `get` (124 usages), `pytest` (113 usages), `append` (100 usages), `Response` (95 usages), `Kupala` (93 usages), `kupala.applications.Kupala` (87 usages), `kupala.responses.Response` (76 usages)
- **Graph size:** 3743 nodes, 14886 edges
- **Breakdown:** 20 builtins, 36 contracts, 48 docs, 97 files, 692 functions, 373 imports, 690 methods, 267 modules, 1021 params, 4 todos, 289 types, 206 variables
