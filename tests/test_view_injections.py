...
def test_injects_from_request(test_client_factory: TestClientFactory) -> None:
    @route("/")
...
def test_injects_from_request_async(test_client_factory: TestClientFactory) -> None:
    @route("/")
...
def test_injectable_generators(test_client_factory: TestClientFactory) -> None:
...
def test_injectable_async_generators(test_client_factory: TestClientFactory) -> None:
...
def test_injects_from_app(test_client_factory: TestClientFactory) -> None:
    @route("/")
...
def test_injects_from_app_async(test_client_factory: TestClientFactory) -> None:
    @route("/")
...
def test_injects_default_raises(test_client_factory: TestClientFactory) -> None:
    @route("/")
...
def test_injects_default_null(test_client_factory: TestClientFactory) -> None:
    @route("/")
...
def test_injects_default_non_null(test_client_factory: TestClientFactory) -> None:
    @route("/")
